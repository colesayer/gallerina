...
class GalleryForm extends Component{
  ...
  render(){
    const floorTexturePicker = floorTextureUrls.map((texture, idx) => (<GalleryFloor key={idx} image={texture} addFloor={this.handleFloorTexture}/>))
    return(
      <div>
        <form onSubmit={this.handleSubmit}>
          ...
          <p>
          <input type="text" onChange={this.handleGalleryName} value={this.state.gallery_name} />
          </p>
          ...
          <p>
          <input type="number" onChange={this.handleDimX} value={this.state.dim_x}/>
          </p>
          ...
          <p>
          <input type="number" onChange={this.handleDimY} value={this.state.dim_y}/>
          </p>
          ...
          <p>
          <input type="number" onChange={this.handleDimZ} value={this.state.dim_z}/>
          </p>
